...
export async function GET(
  ...
  try {
    ...
    // 1. Buscar todas las transacciones de crédito interno del cliente
    ...
    // 2. Buscar todos los pagos que referencian a estas transacciones
